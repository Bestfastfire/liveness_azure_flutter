...
struct CameraView: View {
    ...
    static let previewHeightRatio = CGFloat(3 * sqrt(previewAreaRatio / screenAspectRatio / Double.pi))
    ...
    func getWidth(_ metrics: GeometryProxy) -> CGFloat {
        return metrics.size.width * CameraView.previewWidthRatio
    }
    
    func getHeight(_ metrics: GeometryProxy) -> CGFloat {
        return metrics.size.height * CameraView.previewHeightRatio
    }
